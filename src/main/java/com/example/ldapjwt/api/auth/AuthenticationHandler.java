...
import com.example.ldapjwt.jwt.JwtIssuer;
import com.example.ldapjwt.jwt.JwtTokenResponse;
		...
		return ReactiveSecurityContextHolder.getContext()
			...
			.flatMap(authentication -> {
				...
				return ServerResponse.ok()
					...
					.body(
						BodyInserters.fromValue(new JwtTokenResponse(jwtIssuer.issueToken(authentication.getName(), claims)))
					);
